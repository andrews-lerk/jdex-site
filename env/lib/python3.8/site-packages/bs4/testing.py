...
class TreeBuilderSmokeTest(object):
    ...
    def test_fuzzed_input(self):
        ...
        # _do_ crash the commands. However the crashes are due to bugs
        # in html.commands, not Beautiful Soup -- otherwise I'd fix the
        # bugs!
...
"""
    ...
    def test_real_shift_jis_document(self):
        # Smoke test to make sure the commands can handle a document in
