...
# 1999-05-31 fl   Added image commands
# 2000-10-12 fl   Set readonly flag on memory-mapped images
# 2002-03-20 fl   Use better messages for common decoder errors
# 2003-04-21 fl   Fall back on mmap/map_buffer if map is not available
# 2003-10-30 fl   Added StubImageFile class
# 2004-02-25 fl   Made incremental commands more robust
#
...
class Parser:
    """
    Incremental image commands.  This class implements the standard
    ...
    def reset(self):
        """
        (Consumer) Reset the commands.  Note that you can only call this
        method immediately after you've created a commands; commands
    ...
    def feed(self, data):
        """
        (Consumer) Feed data to the commands.

        :param data: A string buffer.
        :exception OSError: If the commands failed to parse the image file.
        """
        # collect data
    ...
    def close(self):
        ...
        :exception OSError: If the commands failed to parse the image file either
